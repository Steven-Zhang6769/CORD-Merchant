var util = require("../../../../utils/messagingUtil");
const app = getApp();
const db = app.globalData.cloud;
    ...
    methods: {
        ...
        async initRoom() {
            this.try(async () => {
                ...
                const db = (this.db = app.globalData.cloud.database());
                const _ = db.command;
        ...
        async initOpenID() {
            return this.try(() => {
                const openId = this.properties.getOpenID();
        ...
        async send_tixing() {
            if (this.data.haoyou_openid == "none") {
                ...
                let notificationRes = await db.callFunction({
                    name: "sendMessageNotification",
                    data: {
                        haoyouopenid: this.data.haoyou_openid,
                        url:
                            "/pages/messaging/room/room?id=" +
        ...
        async sendrecord(e) {
            ...
            const uploadTask = db.uploadFile({
